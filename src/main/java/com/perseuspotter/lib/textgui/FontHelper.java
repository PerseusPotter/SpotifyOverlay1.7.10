...
public class FontHelper {
    public static class LineData {
        ...
        public final TextLayout tylA;
        public final TextLayout tylB;

        LineData(AttributedString a, AttributedString b, obfObj[] o, double w, double vw, TextLayout tylA, TextLayout tylB) {
            this.a = a;
            this.b = b;
            this.o = o;
            this.w = w;
    ...
    public static LineData processString(String str, boolean shadow, Graphics2D g, Font f1, Font f2, Font f3, int FONT_RENDERER_SIZE) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            sb.append(obfS >= 0 ? obfuscate(c) : c);
        }
        ...
        TextLayout tylA = new TextLayout(a.getIterator(), g.getFontRenderContext());
        TextLayout tylB = b == null ? null : new TextLayout(b.getIterator(), g.getFontRenderContext());

        return new LineData(a, b, o.toArray(new obfObj[0]), tylA.getAdvance(), tylA.getVisibleAdvance(), tylA, tylB);
    }
}
